...
public static String version() {return "1.2.1.dev.1"}
...
metadata 
{
    definition(name: "Replica Samsung OCF AirCon", namespace: "replica", author: "bloodtick", importUrl:"https://raw.githubusercontent.com/bloodtick/Hubitat/main/hubiThingsReplica/devices/replicaSamsungOcfAirCon.groovy")
    {
        ...
        command "setSpiMode", [[name: "mode*", type: "ENUM", description: "Set SPI mode", constraints: ["off", "on"]]] //capability "custom.spiMode" in SmartThings
...
Map getReplicaCommands() {
    return ([ "setSwitchValue":[[name:"switch*",type:"ENUM"]], "setSwitchOff":[], "setSwitchOn":[], "setAirConditionerModeValue":[[name:"airConditionerMode*",type:"STRING"]], "setSupportedAcModesValue":[[name:"supportedAcModes*",type:"JSON_OBJECT"]], 
              ...
              "setPowerConsumptionValue":[[name:"powerConsumption*",type:"JSON_OBJECT"]], "setVolumeValue":[[name:"volume*",type:"NUMBER"]], "setDataValue":[[name:"data*",type:"JSON_OBJECT"]], "setSpiModeValue":[[name:"spiMode*",type:"ENUM"]], "setSpiModeOff":[], "setSpiModeOn":[], 
...
Map getReplicaTriggers() {
    return ([ "off":[] , "on":[], "setAirConditionerMode":[[name:"mode*",type:"STRING"]], "setFanMode":[[name:"fanMode*",type:"STRING"]], "setFanOscillationMode":[[name:"fanOscillationMode*",type:"ENUM"]], "setCoolingSetpoint":[[name:"setpoint*",type:"NUMBER"]], 
