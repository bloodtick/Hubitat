...
metadata 
{
    definition(name: "Replica Samsung OCF TV", namespace: "replica", author: "bloodtick", importUrl:"https://raw.githubusercontent.com/bloodtick/Hubitat/main/hubiThingsReplica/devices/replicaSamsungOcfTv.groovy")
    {
        ...
        command "remoteControl", [ //default is "PRESS_AND_RELEASED"
            [name: "Key Value*", type: "ENUM", description: "Remote Button Value ", constraints: ["OK","UP","DOWN","LEFT","RIGHT","BACK","MENU","HOME","PLAY","PAUSE","REWIND","FASTFORWARD","STOP",
            ...
            [name: "Key State", type: "ENUM", description: "Optional: Remote Button Action State ", constraints: ["PRESS_AND_RELEASED","PRESSED","RELEASED"]]
        ]
    ...
    preferences {
        ...
        input(name:"deviceRuleVersion", type:"enum",  title: "Device Default Replica Rule Set", description: "Allows for default rule selection in cases there are known API changes. Enable 'Reset Device to Default State' preference to reload rules", options:["1","2"], defaultValue: "1")
