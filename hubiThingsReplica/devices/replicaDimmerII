...
metadata 
{
    definition(name: "Replica Dimmer II", namespace: "replica", author: "bloodtick", importUrl:"https://raw.githubusercontent.com/bloodtick/Hubitat/main/hubiThingsReplica/devices/replicaDimmerII.groovy")
    {
        capability "Actuator"
