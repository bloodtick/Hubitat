...
static Map getReplicaCommands() {
    return ([ "setAccelerationValue":[[name:"acceleration*",type:"ENUM"]], "setAccelerationActive":[], "setAccelerationInactive":[], "setBatteryValue":[[name:"battery*",type:"NUMBER"]], 
              ...
              "setThreeAxisValue":[[name:"threeAxis*",type:"VECTOR3"]], "setIlluminanceValue":[[name:"illuminance*",type:"NUMBER"]], "setHealthStatusValue":[[name:"healthStatus*",type:"ENUM"]]])
}
...
def setIlluminanceValue(value) {
    String descriptionText = "${device.displayName} illuminance is $value"
