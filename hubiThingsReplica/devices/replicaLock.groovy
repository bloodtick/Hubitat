...
String getReplicaRules() {
    return """{"version":1,"components":[{"trigger":{"name":"deleteCode","label":"command: deleteCode(codeSlot*)","type":"command","parameters":[{"name":"codeSlot*","type":"NUMBER"}]},"command":{"name":"deleteCode","arguments":[{"name":"codeSlot","optional":false,"schema":{"title":"PositiveInteger","type":"integer","minimum":0}}],"type":"command","capability":"lockCodes","label":"command: deleteCode(codeSlot*)"},"type":"hubitatTrigger"},{"trigger":{"name":"nameSlot","label":"command: nameSlot(codeSlot*, codeName*)",\
"type":"command","parameters":[{"name":"codeSlot*","type":"NUMBER"},{"name":"codeName*","type":"STRING","data":"codeName"}]},"command":{"name":"nameSlot","arguments":[{"name":"codeSlot","optional":false,"schema":{"title":"PositiveInteger","type":"integer","minimum":0}},{"name":"codeName","optional":false,"schema":{"maxLength":255,"title":"String","type":"string"}}],"type":"command","capability":"lockCodes","label":"command: nameSlot(codeSlot*, codeName*)"},"type":"hubitatTrigger"},{"trigger":{"name":"refresh","label":"command: refresh()",\
"type":"command"},"command":{"name":"refresh","type":"command","capability":"refresh","label":"command: refresh()"},"type":"hubitatTrigger"},{"trigger":{"name":"reloadAllCodes","label":"command: reloadAllCodes()","type":"command"},"command":{"name":"reloadAllCodes","type":"command","capability":"lockCodes","label":"command: reloadAllCodes()"},"type":"hubitatTrigger"},{"trigger":{"name":"requestCode","label":"command: requestCode(codeSlot*)","type":"command","parameters":[{"name":"codeSlot*","type":"NUMBER"}]},\
"command":{"name":"requestCode","arguments":[{"name":"codeSlot","optional":false,"schema":{"title":"PositiveInteger","type":"integer","minimum":0}}],"type":"command","capability":"lockCodes","label":"command: requestCode(codeSlot*)"},"type":"hubitatTrigger"},{"trigger":{"name":"setCode","label":"command: setCode(codeSlot*, codePIN*, codeName)","type":"command","parameters":[{"name":"codeSlot*","type":"NUMBER"},{"name":"codePIN*","type":"STRING","data":"codePIN"},{"name":"codeName","type":"STRING","data":"codeName"}]},\
"command":{"name":"setCode","arguments":[{"name":"codeSlot","optional":false,"schema":{"title":"PositiveInteger","type":"integer","minimum":0}},{"name":"codePIN","optional":false,"schema":{"maxLength":255,"title":"String","type":"string"}},{"name":"codeName","optional":false,"schema":{"maxLength":255,"title":"String","type":"string"}}],"type":"command","capability":"lockCodes","label":"command: setCode(codeSlot*, codePIN*, codeName*)"},"type":"hubitatTrigger"},{"trigger":{"name":"setCodeLength",\
"label":"command: setCodeLength(length*)","type":"command","parameters":[{"name":"length*","type":"NUMBER"}]},"command":{"name":"setCodeLength","arguments":[{"name":"length","optional":false,"schema":{"title":"PositiveInteger","type":"integer","minimum":0}}],"type":"command","capability":"lockCodes","label":"command: setCodeLength(length*)"},"type":"hubitatTrigger"},{"trigger":{"name":"unlockWithTimeout","label":"command: unlockWithTimeout()","type":"command"},"command":{"name":"unlockWithTimeout","type":"command",\
"capability":"lockCodes","label":"command: unlockWithTimeout()"},"type":"hubitatTrigger"},{"trigger":{"name":"updateCodes","label":"command: updateCodes(codes*)","type":"command","parameters":[{"name":"codes*","type":"JSON_OBJECT"}]},"command":{"name":"updateCodes","arguments":[{"name":"codes","optional":false,"schema":{"title":"JsonObject","type":"object"}}],"type":"command","capability":"lockCodes","label":"command: updateCodes(codes*)"},"type":"hubitatTrigger"},{"trigger":{"type":"attribute",\
"properties":{"value":{"title":"HealthState","type":"string"}},"additionalProperties":false,"required":["value"],"capability":"healthCheck","attribute":"healthStatus","label":"attribute: healthStatus.*"},"command":{"name":"setHealthStatusValue","label":"command: setHealthStatusValue(healthStatus*)","type":"command","parameters":[{"name":"healthStatus*","type":"ENUM"}]},"type":"smartTrigger","mute":true},{"trigger":{"title":"IntegerPercent","type":"attribute","properties":{"value":{"type":"integer","minimum":0,"maximum":100},\
"unit":{"type":"string","enum":["%"],"default":"%"}},"additionalProperties":false,"required":["value"],"capability":"battery","attribute":"battery","label":"attribute: battery.*"},"command":{"name":"setBatteryValue","label":"command: setBatteryValue(battery*)","type":"command","parameters":[{"name":"battery*","type":"NUMBER"}]},"type":"smartTrigger","mute":true},{"trigger":{"type":"attribute","properties":{"value":{"maxLength":255,"title":"String","type":"string"},"data":{"type":"object","additionalProperties":false,"required":[],\
"properties":{"codeName":{"type":"string"}}}},"additionalProperties":false,"required":[],"capability":"lockCodes","attribute":"codeChanged","label":"attribute: codeChanged.*"},"command":{"name":"setCodeChangedValue","label":"command: setCodeChangedValue(codeChanged*)","type":"command","parameters":[{"name":"codeChanged*","type":"ENUM"}]},"type":"smartTrigger"},{"trigger":{"type":"attribute","properties":{"value":{"title":"PositiveInteger","type":"integer","minimum":0}},"additionalProperties":false,"required":[],\
"capability":"lockCodes","attribute":"codeLength","label":"attribute: codeLength.*"},"command":{"name":"setCodeLengthValue","label":"command: setCodeLengthValue(codeLength*)","type":"command","parameters":[{"name":"codeLength*","type":"NUMBER"}]},"type":"smartTrigger"},{"trigger":{"type":"attribute","properties":{"value":{"title":"PositiveInteger","type":"integer","minimum":0}},"additionalProperties":false,"required":["value"],"capability":"lockCodes","attribute":"codeReport","label":"attribute: codeReport.*"},\
"command":{"name":"setCodeReportValue","label":"command: setCodeReportValue(codeReport*)","type":"command","parameters":[{"name":"codeReport*","type":"NUMBER"}]},"type":"smartTrigger"},{"trigger":{"type":"attribute","properties":{"value":{"title":"LockState","type":"string"},"data":{"type":"object","additionalProperties":false,"required":[],"properties":{"method":{"enum":["manual","keypad","auto","command","rfid","fingerprint","bluetooth"],"type":"string"},"codeName":{"type":"string"},"codeId":{"type":"string"},\
"timeout":{"pattern":"removed","title":"Iso8601Date","type":"string"}}}},"additionalProperties":false,"required":["value"],"capability":"lockCodes","attribute":"lock","label":"attribute: lock.*"},"command":{"name":"setLockValue","label":"command: setLockValue(lock*)","type":"command","parameters":[{"name":"lock*","type":"ENUM"}]},"type":"smartTrigger"},{"trigger":{"type":"attribute","properties":{"value":{"maxLength":255,"title":"String","type":"string"}},"additionalProperties":false,"required":[],"capability":"lockCodes",\
"attribute":"lockCodes","label":"attribute: lockCodes.*"},"command":{"name":"setLockCodesValue","label":"command: setLockCodesValue(lockCodes*)","type":"command","parameters":[{"name":"lockCodes*","type":"JSON_OBJECT"}]},"type":"smartTrigger"},{"trigger":{"type":"attribute","properties":{"value":{"title":"PositiveInteger","type":"integer","minimum":0}},"additionalProperties":false,"required":[],"capability":"lockCodes","attribute":"maxCodeLength","label":"attribute: maxCodeLength.*"},"command":{"name":"setMaxCodeLengthValue",\
"label":"command: setMaxCodeLengthValue(maxCodeLength*)","type":"command","parameters":[{"name":"maxCodeLength*","type":"NUMBER"}]},"type":"smartTrigger"},{"trigger":{"type":"attribute","properties":{"value":{"title":"PositiveInteger","type":"integer","minimum":0}},"additionalProperties":false,"required":[],"capability":"lockCodes","attribute":"maxCodes","label":"attribute: maxCodes.*"},"command":{"name":"setMaxCodesValue","label":"command: setMaxCodesValue(maxCodes*)","type":"command","parameters":[{"name":"maxCodes*","type":"NUMBER"}]},\
