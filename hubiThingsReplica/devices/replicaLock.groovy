...
metadata 
{
    definition(name: "Replica Lock", namespace: "replica", author: "bloodtick", importUrl:"https://raw.githubusercontent.com/bloodtick/Hubitat/main/hubiThingsReplica/devices/replicaLock.groovy")
    {
        ...
        command "setBattery", [[name: "battery*", type: "NUMBER", description: "Set Battery level %"]] //updated to support SmartThings Virtual Lock
...
static Map getReplicaTriggers() {
    return ([ "setBattery":[[name:"battery*",type:"NUMBER"]], "updateCodes":[[name:"codes*",type:"JSON_OBJECT"]], "unlockWithTimeout":[], "setCodeLength":[[name:"length*",type:"NUMBER"]], "requestCode":[[name:"codeSlot*",type:"NUMBER"]], "reloadAllCodes":[], "nameSlot":[[name:"codeSlot*",type:"NUMBER"],[name:"codeName*",type:"STRING",data:"codeName"]], 
